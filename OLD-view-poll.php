...
<head>
    ...
    <link rel="stylesheet" href="css/view-poll.css">
...
if(isset($_SESSION['loggedIn']) && $_SESSION['loggedIn']){
    ...
    try {
        ...
        if(count($pollDetails) != 0){
            ...
            echo "<div class='title'> <h3> Question: " . $pollDetails[0]['question'] . "</h3> </div>";
            echo "<div class='ST'><h3> Poll Status:" . $pollDetails[0]['poll_status'] . "</h3>";
            if($pollDetails[0]['end_date'] != '0000-00-00' && $pollDetails[0]['poll_status'] == 'active'){
                echo "<h3> Active Till: " . $pollDetails[0]['end_date'] . "</h3></div>";
            }
            ...
            if($pollDetails[0]['poll_status'] == 'active'){
                ...
                if(count($result2)==0){
                    ...
                    echo '
                    <div class="option"> <h4>Options:</h4> </div>
                    ...
                    echo '<div class="R-SUBMIT">
                    <input type="submit" value="submit" name="submit-vote"></div>
                    </form>
                    ';
                    echo "<div class='submit'> <a href='index.php'>Home</a></div>";
