...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2023 at 08:29 PM
...
--
-- Database: `itcs333-project-group-2`
--
CREATE DATABASE IF NOT EXISTS `itcs333-project-group-2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `itcs333-project-group-2`;
...
(64, 'What course do you prefer?', 6, 19, 'active', '2023-12-23', '2023-12-28'),
(65, 'Best programming language?', 6, 19, 'active', '2023-12-23', '2023-12-25'),
...
(74, 'The best?', 2, 24, 'active', '0000-00-00', '0000-00-00');
...
(23, 'Andrew Tate', 'andrew123@gmail.com', '$2y$10$/76HOeJr8bznG38N7bAlzu188.qLfRbyV/BF4mJ2P6Ip6CGzbhRq6', ''),
...
--
ALTER TABLE `answers`
  MODIFY `answer_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;

--
-- AUTO_INCREMENT for table `poll`
--
ALTER TABLE `poll`
  MODIFY `poll_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `voted`
  MODIFY `vote_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
